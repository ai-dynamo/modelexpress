...
type PublishMetadataRequest struct {
	...
	// Used with pod_uid to set an ownerReference on the ModelMetadata CR
	// so K8s garbage-collects it when the pod is deleted.
	// When empty, no ownerReference is set.
...
const file_p2p_proto_rawDesc = "" +
	...
	"\vartifact_id\x18\x02 \x01(\tR\n" +
	"artifactId\x12>\n" +
	"\x05chunk\x18\x03 \x01(\v2(.model_express.p2p.ArtifactManifestChunkR\x05chunk\"\xe3\x01\n" +
	...
	"\apod_uid\x18\x05 \x01(\tR\x06podUid\"\x8c\x01\n" +
