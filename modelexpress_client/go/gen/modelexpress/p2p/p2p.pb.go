...
type SourceInstanceRef struct {
	...
	ActiveTransfers uint32 `protobuf:"varint,6,opt,name=active_transfers,json=activeTransfers,proto3" json:"active_transfers,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_p2p_proto_rawDesc = "" +
	...
	"mxSourceId\x12\x1b\n" +
	"\tworker_id\x18\x04 \x01(\tR\bworkerId\"\xdf\x01\n" +
	...
	"\x10active_transfers\x18\x06 \x01(\rR\x0factiveTransfers\"\xb0\x01\n" +
