...
const (
	HealthService_GetHealth_FullMethodName = "/model_express.health.HealthService/GetHealth"
)
...
//
// Health service for server status checks
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "model_express.health.HealthService",
