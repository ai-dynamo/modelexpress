...
class P2pServiceServicer(object):
    ...
    def ListSources(self, request, context):
        """List available source instances - lightweight, no tensor metadata
        Call this first to discover available instances, then GetMetadata for the chosen one
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def GetMetadata(self, request, context):
        """Fetch full tensor metadata for one specific instance
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
