...
def _make_manager(env, agent):
    ...
    mgr._metadata = b""
    # Match __init__'s default. Real code paths set this via
    # register_tensors / rebind_tensors; the bypass constructor
    # skips those, so wire the field explicitly here.
    mgr._local_mem_type = "cuda"
    return mgr
