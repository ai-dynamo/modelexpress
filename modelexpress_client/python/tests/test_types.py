    ...
    def test_found_response(self):
        ...
        workers = [
            WorkerMetadata(
                ...
                worker_grpc_endpoint=f"10.0.1.{i}:60051",
            )
            for i in range(4)
        ]
