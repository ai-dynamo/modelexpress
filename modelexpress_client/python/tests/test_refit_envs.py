...
def test_defaults_when_unset(monkeypatch):
    ...
    assert envs.MX_GENERATOR_ENGINE == "VLLM"
    assert envs.MX_GENERATOR_INSTALLATION_MODE == "STAGED"
...
def test_values_are_normalized_and_read_live(monkeypatch):
    monkeypatch.setenv("MX_GENERATOR_ENGINE", " vllm ")
    monkeypatch.setenv("MX_GENERATOR_INSTALLATION_MODE", " direct ")
    ...
    assert envs.MX_GENERATOR_ENGINE == "VLLM"
    assert envs.MX_GENERATOR_INSTALLATION_MODE == "DIRECT"
    assert envs.MX_TRAINER_ENGINE == "MEGATRON"
