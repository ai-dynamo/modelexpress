...
from .multiaddr import encode_multiaddr_ip4_tcp, encode_multiaddr_ip4_tcp_p2p
...
async def accept(
    ...
    log.info(f"noise handshake complete (responder), remote peer: {noise.remote_peer_id.hex()[:16]}...")
