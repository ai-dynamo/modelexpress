...
hostnames.  Commonly fed from the ``SLURM_JOB_NODELIST`` environment variable
to bootstrap a peer network from the job's node allocation without requiring
explicit per-peer configuration or DNS.
"""
